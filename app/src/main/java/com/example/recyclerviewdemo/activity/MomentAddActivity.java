...
import com.example.recyclerviewdemo.AddCircleActivity;
...
public class MomentAddActivity extends BGAPPToolbarActivity implements
    ...
    public static Circle getCircle(Intent intent) {
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.tv_moment_add_choice_photo) {
            ...
            circle.setContent(mContentEt.getText().toString());
            circle.setPhotos(mPhotosSnpl.getData());
            boolean isSave =  circle.save();
            Log.d(TAG, "Is save success ? ---- " + isSave);

            Intent intent = new Intent(MomentAddActivity.this, MainActivity.class);
//                setResult(RESULT_OK,intent);
            startActivity(intent);

//            Intent intent = new Intent();
            intent.putExtra(EXTRA_MOMENT, new Circle(mContentEt.getText().toString().trim(), mPhotosSnpl.getData()));
//            setResult(RESULT_OK, intent);
            finish();
        }
    }
